        ...
        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-xl-3 g-4">
            <div class="col">
                <div class="card h-100">
                    <div class="card-img">
                        <img src="{{ asset('images/logo-html.png') }}" class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-img">
                        <img src="{{ asset('images/logo-laravel.png') }}" class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">HTML/CSS/js Tutorial</h5>
                        <p class="card-text">
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-img">
                        <img src="{{ asset('images/logo-php.png') }}" class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">HTML/CSS/js Tutorial</h5>
                        <p class="card-text">
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-xl-3 g-4">
            <div class="col">
                <div class="card h-100">
                    <div class="card-img">
                        <img src="{{ asset('images/logo-css.png') }}" class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">HTML/CSS/js Tutorial</h5>
                        <p class="card-text">
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-img ">
                        <img src="{{ asset('images/logo-ruby-1.png') }}" class="card-img-top card-ruby" alt="...">
                        <img src="{{ asset('images/logo-ruby-2.png') }}" class="card-img-top card-ruby-2" alt="...">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">HTML/CSS/js Tutorial</h5>
                        <p class="card-text">
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="card-img">
                        <img src="{{ asset('images/logo-java.png') }}" class="card-img-top" alt="...">
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">HTML/CSS/js Tutorial</h5>
                        <p class="card-text">
